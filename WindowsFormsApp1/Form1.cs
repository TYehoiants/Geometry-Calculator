...
namespace Lab4_Shapes
{
    public partial class Form1 : Form
    {
        ...
        private void UpdateList()
        {
            ...
            lblTotalArea.Text = "Total area: " + container.GetTotalArea().ToString("F2");
        }
        ...
        private void btnAddCircle_Click(object sender, EventArgs e)
        {
            ...
            catch { MessageBox.Show("Check your input"); }
        }
        ...
        private void lblTotalArea_Click(object sender, EventArgs e)
        {
